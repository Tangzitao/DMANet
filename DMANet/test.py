...
import os
import cv2
from network import Netm, DMANet
...
if __name__ == '__main__':
    ...
    net = DMANet(kernel_mode=config.train['kernel_mode'], num_res=2, base_ch=config.train['base_ch'], num_gaussian_kernels=config.train['kernel_size'],
